...
init:
    ...
    image bk3_dlfight = "bk3_fight/dailee_1.png"
    image bk3_dlfight_flipped = im.Flip("bk3_fight/dailee_1.png",horizontal=True)
...
label love_bk3_start_the_fight:
    ...
    jump love_bk3_final_fighttweaks





label love_bk3_final_fighttweaks:
    ...
    if current_room.roomnr in [66,71,90]:
    ...
    if current_room.roomnr in [81,77,109]:

        $ bk3_current_enemy = "dleefight"
        $ bk3_enemy_type = "earth"
        $ bk3_enemy_life_start = 100
        $ bk3_enemy_life = 100
        $ bk3_attacktype = 'human_slash'
    ...
    if bk3_enemy_firststrike:
        jump love_bk3_enemy_turn
    else:

        call screen love_bk3_fighting_interface
...
screen love_bk3_fighting_interface:
    ...
    imagemap:
        ...
        if bk3_lifepotions >= 1:
            hotspot (75, 279, 120, 120) action [SetVariable("bk3_attack_type","bk3_lifepotion"),   Jump("love_bk3_players_turn")]
            text "{b}[bk3_lifepotions]" xpos 172 ypos 283

        if bk3_manapotions >= 1:
            hotspot (75, 151, 120, 120) action [SetVariable("bk3_attack_type","bk3_manapotion"),   Jump("love_bk3_players_turn")]
            text "{b}[bk3_manapotions]" xpos 172 ypos 157

        if bk3_allow_firebending == True and bk3_fire_remaining >0:
            hotspot (77, 612, 90, 104) action [SetVariable("bk3_attack_type","fire"),             Jump("love_bk3_players_turn")]
            hotspot (170, 614, 111, 103) action [SetVariable("bk3_attack_type","fire_spread"),      Jump("love_bk3_players_turn")]
            text "{color=#ffffff}[bk3_fire_remaining]/[bk3_moves]" xpos 60 ypos 620

        if bk3_allow_waterbending == True and bk3_water_remaining >0:
            hotspot (76, 507, 93, 99) action [SetVariable("bk3_attack_type","water")       ,     Jump("love_bk3_players_turn")]
            hotspot (169, 507, 109, 102) action [SetVariable("bk3_attack_type","water_spread"),     Jump("love_bk3_players_turn")]
            text "{color=#ffffff}[bk3_water_remaining]/[bk3_moves]" xpos 60 ypos 510

        if bk3_allow_earthbending == True:
            hotspot (76, 398, 93, 107) action [SetVariable("bk3_attack_type","earth"),            Jump("love_bk3_players_turn")]
            hotspot (168, 395, 116, 111) action [SetVariable("bk3_attack_type","earth_spread"),     Jump("love_bk3_players_turn")]
            text "{color=#ffffff}{image=infinity1.png}" xpos 60 ypos 400




screen love_bk3_lifebars:
...
label love_bk3_players_turn:
    ...
    if bk3_attack_type == "fire":
        ...
        if bk3_lifepotions >= 1:
            ...
            call love_bk3_calculate_lifebar_positions from _call_love_bk3_calculate_lifebar_positions
    ...
    jump love_dealing_with_damage_etc
...
label love_dealing_with_damage_etc:

    call love_bk3_calculate_your_attack_bonus from _call_love_bk3_calculate_your_attack_bonus
    ...
    if bk3_enemy_life <=0:
        ...
        jump love_bk3_fight_endstate

    call love_bk3_calculate_lifebar_positions from _call_love_bk3_calculate_lifebar_positions_1

    if bk3_enemy_potions >= 1:
        if bk3_enemy_life >=1 and bk3_enemy_life <= (int(bk3_enemy_life_start/3)):
            $ bk3_enemy_potions -= 1
            $ bk3_enemy_life = bk3_enemy_life_start
            "The enemy drinks a potion and is healed!"
            play sound "audio/win2.mp3"
            call love_bk3_calculate_lifebar_positions from _call_love_bk3_calculate_lifebar_positions_2
...
label love_bk3_calculate_your_attack_bonus:
...
label love_bk3_calculate_lifebar_positions:
...
label love_bk3_fight_endstate:
    ...
    if bk3_current_enemy == "bmole":
        if bk3_player_life <= 0:
            ...
            $ bk3_ypos_lifebar_player = 0
            $ bk3_day = False
            jump love_inside_hospital_building
        else:
            ...
            if level_up:
                ...
                call screen love_bk3_level_up_stats2
    ...
    jump love_bk3_after_fight_win


label love_bk3_after_fight_win:

    if level_up:
        $ level_up = False
        $ bk3_leveling_screen = True
        call screen love_bk3_level_up_stats        
    ...
    if ajala_jd_hypno_fight:
        ...
        $ ajala_jd_hypno_fight2 = True
        if jd_break_hypno >=2:
            jump ajala_wonfight_1
        else:
            jump ajala_wonfight_10
    else:
        ...
        menu:
            ...
            "My dick is hard and ready to go!":
                jump love_bk3_winnerfucksall



label love_bk3_winnerfucksall:
...
screen love_bk3_level_up_stats1:
...
screen love_bk3_level_up_stats:
    add "misc/bk3_scroll.jpg"
    ...
    if bk3_leveling_screen:
        if bk3_level_points >=1:
            ...
            textbutton "{color=#000000}Accuracy" action [SetVariable("accuracy_boost", True), Jump("love_bk3_points")] xpos 270 ypos 520
            textbutton "{color=#000000}Evasion" action [SetVariable("evasion_boost", True), Jump("love_bk3_points")] xpos 470 ypos 520
            textbutton "{color=#000000}Health" action [SetVariable("health_boost", True), Jump("love_bk3_points")] xpos 670 ypos 520


    textbutton "{color=#000000}Return" action [SetVariable("bk3_leveling_screen", True), Jump("love_bk3_after_fight_win")] xpos 470 ypos 620

screen love_bk3_level_up_stats2:
    add "misc/bk3_scroll.jpg"
    text "{color=#000000}Level:" xpos 340 ypos 130
    text "{color=#000000}[bk3_level]" xpos 640 ypos 130
    text "{color=#000000}Health:" xpos 340 ypos 180
    ...
    textbutton "{color=#000000}Return" action [SetVariable("bk3_leveling_screen", True), Jump("love_bk3_maze_start")] xpos 470 ypos 620


label love_bk3_points:
    $ accuracy_predict = bk3_accuracy+1
    $ evasion_predict = bk3_evade + 1
    $ health_predict = bk3_hp + 5
    show screen love_bk3_level_up_stats
    if accuracy_boost:
        $ bk3_accuracy +=1
        $ bk3_level_points -=1
