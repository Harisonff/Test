label shady_crab_battle:
    ...
    if shady_crab ==9:
        ...
        jump shady_crab_battle_player
    if shady_crab ==10:
        show muskycrabshuffle with dissolve
        $ crab_health = 250
        $ normal_crab = False
        $ strong_crab = False
        $ legend_crab = False
...
label shady_crab_battle_player:
    ...
    if crab_standin:
        if crab_standin_health <=0:
            if crab_standin_normal:
                ...
                jump shady_crab_battle_player2
...
label shady_crab_battle_player2:
    menu:
        ...
        "hyper-boom snip - powerful, takes an extra turn, always hits" if crab_standin and not crab_standin_bessie:
            $ hyperboom = 1
...
label shady_crab_battle_crab:
    if crab_health <=0:
        ...
        if shady_crab == 1:
            $ shady_crab = 2
            $ remaining_enemy_crabs = 8
            sg "don't get too excited, i've got more!"
            jump shady_crab_battle_next
